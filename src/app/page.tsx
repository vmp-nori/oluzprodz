...
import { DesktopNotice } from "@/domains/experience/components/desktop-notice";
      ...
      <main className="desktop-site">
        ...
        >
          <div className="experience-heading">
            ...
            <p>
              Olu turns live moments into visual stories built for attention,
              from the sideline to the feed.
            </p>
          </div>
          ...
          >
            <div className="primary-metric">
              ...
              <div>
                ...
                <small>
                  Illustrative data · replace with verified analytics
                </small>
              </div>
            </div>
        ...
        >
          <div className="capabilities-heading">
            ...
            <p>
              From live capture to final export, Olu brings the production
              skills and editing workflow to carry every story through.
            </p>
          </div>
